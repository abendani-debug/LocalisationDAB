      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 h-16 flex items-center gap-6">
          <a href="#" className="flex items-center gap-2 flex-shrink-0">
            <Image src="/images/logo.png" alt="MapsDab" width={40} height={40} className="rounded-lg" />
          </a>
        ...
        {menuOpen && (
          ...
          >
            <div className="flex items-center justify-between p-4 border-b border-border">
              <Image src="/images/logo.png" alt="MapsDab" width={36} height={36} className="rounded-lg" />
